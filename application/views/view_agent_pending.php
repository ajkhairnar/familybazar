        ...
        <div class="col-md-12">
          ...
          <div class="ms-panel">
            ...
            <form class=" clearfix" >
                ...
                <div class="form-row">
                <div class="col-md-4 col-sm-4 mb-3 text-center"><a class="btn btn-success d-block float-right" href="<?=base_url()?>agents/agent_approve/<?=$result->agent_id?>">Approve</a></div>
                <div class="col-md-4 col-sm-4 mb-3 text-center"><a class="btn btn-primary d-block float-right" href="<?=base_url()?>agents/agent_decline/<?=$result->agent_id?>">Decline</a></div>
                <div class="col-md-4 col-sm-4 mb-3 text-center"><a class="btn btn-primary d-block float-right" href="<?=base_url()?>agents/agent_manage" >Cancel</a></div>
                </div>
